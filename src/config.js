global.SALT_KEY =  'AIzaSyDA-mDRr-qodw-EAvx-G6HUNG3zMCRf'; 
global.EMAIL_TMPL = 'Olá, <strong>{0}</strong>, seja bem vindo a Task List';

module.exports = {
	//connectionString: 'mongodb://localhost/testedb',
